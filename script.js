const GITHUB_USERNAME = "AdarshVashith";
const DISPLAY_NAME = "Adarsh";
const DISPLAY_ROLE = "Data Scientist";
const DISPLAY_BIO =
  "Leveraging data to solve complex problems. Focused on machine learning, data visualization, and engineering robust analytics solutions.";
